#!/usr/bin/env python3
"""
Render Hero Model to 2D Sprite
"""
...
def setup_render():
    """Configure render settings for hero sprite"""
    scene = bpy.context.scene

    # Resolution (256x256 for heroes)
...
def main():
    ...
    output_dir = f"{script_dir}/renders/heroes"
    os.makedirs(output_dir, exist_ok=True)

    output_path = f"{output_dir}/hero_e00_ancient_king.png"
